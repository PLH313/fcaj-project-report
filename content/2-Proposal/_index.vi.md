...
- *Amazon Athena*: Cho phép truy vấn SQL trên lịch sử logs.
- *Amazon SNS*: Gửi alerts và notifications cho logs error.
...
- *Notification & Response Layer*: SQS xếp hàng events, SNS phân phối alerts, và CloudWatch kích hoạt phát hiện logs error.
